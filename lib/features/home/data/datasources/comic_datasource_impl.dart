...
class ComicRemoteDataSourceImpl implements ComicRemoteDataSource {
  ...
  Future<List<RecentEpisode>> getRecentEpisodes() async {
    try {
      ...
      List<RecentEpisode> _recentEpisodesList = [];
      ...
      for (QueryDocumentSnapshot _recentComic in _querySnapshot.docs) {
        ...
        _recentEpisodesList.add(RecentEpisodeModel(
  ...
  @override
  Future<List<RecentEpisode>> getEpisodes(String comicId) async {
    try {
      QuerySnapshot _querySnapshot = await firebaseFirestore
          .collection("episodes")
          .orderBy("episode_name")
      ...
      List<RecentEpisode> _episodeList = [];
