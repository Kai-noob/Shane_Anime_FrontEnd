...
abstract class $GenreCopyWith<$Res> {
  ...
  $Res call({@JsonKey(ignore: true) String? id, String name, String icon});
}
...
class _$_Genre implements _Genre {
  const _$_Genre(
      {@JsonKey(ignore: true) this.id, required this.name, required this.icon});
